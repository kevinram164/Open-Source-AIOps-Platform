...
**Phase hiện tại: Phase 0 (Discovery) + Phase 1 (Foundation)**
...
Chi tiết: [docs/architecture.md](docs/architecture.md) | [docs/high-level-design.md](docs/high-level-design.md) | [diagrams/](diagrams/)
